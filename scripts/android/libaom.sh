...
# Add cpufeatures include path for Android
CPUFEATURES_INCLUDE="-I${ANDROID_NDK_ROOT}/sources/android/cpufeatures"
...
cmake -Wno-dev \
  ...
  -DCONFIG_PIC=1 \
  -DCMAKE_C_FLAGS="${CFLAGS} ${CPUFEATURES_INCLUDE}" \
  -DCMAKE_CXX_FLAGS="${CXXFLAGS} ${CPUFEATURES_INCLUDE}" \
