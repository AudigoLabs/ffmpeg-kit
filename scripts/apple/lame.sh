...
overwrite_file "${FFMPEG_KIT_TMPDIR}"/source/config/config.guess ./config.guess || return 1
overwrite_file "${FFMPEG_KIT_TMPDIR}"/source/config/config.sub ./config.sub || return 1
